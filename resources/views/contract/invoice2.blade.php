...
<html>
    <head>
        <meta charset="UTF-8">
        <title>ใบเรียกเก็บค่าย้ายห้องพัก/เปลี่ยนสัญญา #{{ $invoice->invoice }}</title>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="text-center">
                    <h3>ใบเรียกเก็บค่าย้ายห้องพัก/เปลี่ยนสัญญา #{{ $invoice->invoice }}</h3>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-condensed">
                                ...
                                <tbody>
                                    <tr>
                                        <td>ค่าห้องพัก ห้องเลขที่ <b>{{ $room->name }}</b> ประเภทห้องพัก <b>{{ $room->type }}</b></td>
                                    ...
                                    @endif
                                    <?php
                                    $total = (($usage[0]['water']-$usage[1]['water'])*$setting->rate_water) + (($usage[0]['power']-$usage[1]['power'])*$setting->rate_elec) + $ins;
                                    ?>
                                    <tr>
